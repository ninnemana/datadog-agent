...
const (
	warningNewKubeCheck       string = "Warning: The Kubernetes integration has been overhauled, please see https://github.com/ninnemana/datadog-agent/blob/master/docs/agent/changes.md#kubernetes-support"
